...
def main(config_path):
    ...
    for epoch in range(config['train']['epochs']):
        ...
        print(f"Epoch {epoch+1} | Acc: {val_acc:.2f}% | mAP: {val_mAP:.4f} | Latency: {val_lat:.2f}ms")
        ...
        if val_acc > best_acc:
            ...
            wandb.log({"best_val_acc": best_acc, "best_val_mAP": best_mAP})
    ...
    if test_loader:
        results.update({"test_acc": t_acc, "test_mAP": t_mAP, "test_lat_ms": t_lat})
